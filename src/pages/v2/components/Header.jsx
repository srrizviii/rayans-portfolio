export default function Header() {
    return (
        <header>
            ...
            <br />
            <nav>
                <a className="anchor-text" href="#about"><h2>About</h2></a>
                <a className="anchor-text" href="#experience"><h2>Experience</h2></a>
                <a className="anchor-text" href="#projects"><h2>Projects (Stay Tuned)</h2></a>
            </nav>
